...
HD_PWD='D:/mtech/EC9032-FPGA Based Design/mac/mac.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mac_testbench.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mac_testbench.tcl
