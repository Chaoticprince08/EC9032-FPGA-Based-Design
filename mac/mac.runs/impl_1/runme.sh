...
HD_PWD='D:/mtech/EC9032-FPGA Based Design/mac/mac.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mac_topmodule.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mac_topmodule.tcl -notrace
