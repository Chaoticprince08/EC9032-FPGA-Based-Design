...
HD_PWD='D:/mtech/EC9032-FPGA Based Design/adder_Q2/adder_Q2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_topmodule.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adder_topmodule.tcl -notrace
