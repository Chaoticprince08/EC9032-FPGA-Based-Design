...
HD_PWD='D:/mtech/EC9032-FPGA Based Design/adder_Q2/adder_Q2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_topmodule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_topmodule.tcl
